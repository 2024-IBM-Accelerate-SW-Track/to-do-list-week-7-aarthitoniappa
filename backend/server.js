...
async function addItem(request, response) {
  try {
    ...
    console.log('Extracted item details:', { id, task, currentDate, dueDate });
    ...
    if (useCloudant) {
      console.log('Writing to Cloudant:', { id, task, currentDate, dueDate });
      ...
      console.log('Successfully wrote to Cloudant DB:', createDocumentResponse.result);
    } else {
      console.log('Writing to local file:', newTask);
